...
*/
#define X_SENSITIVITY           (35.0f)     //マウス操作、左右感度
#define Y_SENSITIVITY           (70.0f)     //マウス操作、上下感度
#define Y_FOLLOWING             (3.00f)     //マウス操作、上下追従補正
